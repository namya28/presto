        ...
        implements ColumnWriter
{
    ...
    public FloatColumnWriter(int column, int sequence, Type type, ColumnWriterOptions columnWriterOptions, MetadataWriter metadataWriter)
    {
        ...
        this.dataStream = new FloatOutputStream(columnWriterOptions);
