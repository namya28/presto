        ...
        implements ColumnWriter
{
    ...
    public DoubleColumnWriter(int column, int sequence, Type type, ColumnWriterOptions columnWriterOptions, MetadataWriter metadataWriter)
    {
        ...
        this.dataStream = new DoubleOutputStream(columnWriterOptions);
